...
use crate::routes::{
    ...
    sessions::{
        complete_session, follow_lab, get_admin_sessions_analytics,
        get_admin_user_dashboard_labs, get_learner_dashboard_labs, get_session_by_id,
...
pub fn init_routes() -> Router<AppState> {
    Router::new()
        ...
        .route("/admin/analytics/sessions", get(get_admin_sessions_analytics))
        // Session lifecycle
